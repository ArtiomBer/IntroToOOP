...
/**
 * The Or class is part of the binary expressions, thus,
 * this class extends the BinaryExpression class.
 * This class contains all of "Or" logic operator methods.
...
public class Or extends BinaryExpression {
    ...
    public Expression nandify() {
        Nand basicNand1 =  new Nand(this.expression1.nandify(), this.expression1.nandify());
        Nand basicNand2 =  new Nand(this.expression2.nandify(), this.expression2.nandify());
        return new Nand(basicNand1, basicNand2);
    }
    /**
    ...
    public Expression norify() {
        Nor basicNor =  new Nor(this.expression1.norify(), this.expression2.norify());
        return new Nor(basicNor, basicNor);
    }
    /**
    ...
    public Expression simplify() {
        ...
        return new Or(simpleExpression1, simpleExpression2);
    }
    /**
