...
/**
 * The Nand class is part of the binary expressions, thus,
 * this class extends the BinaryExpression class.
 * This class contains all of "Nand" logic operator methods.
 * It is in charge of evaluating, assigning, nandifying, norifying
 * and simplifying the Nand expressions.
 */
public class Nand extends BinaryExpression {
    ...
    public Expression norify() {
        ...
        return new Nor(combinedNor, combinedNor);
    }
    /**
    ...
    public Expression simplify() {
        ...
        return new Nand(simpleExpression1, simpleExpression2);
    }
    /**
