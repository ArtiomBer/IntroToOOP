...
public class Paddle implements Sprite, Collidable {
     ...
     * @param paddleSpeed is the given paddle speed.
     * @param paddleWidth is the given paddle width.
     */
    public Paddle(GUI gui, int paddleSpeed, int paddleWidth) {
        ...
        this.paddleRectangle = new Rectangle(new Point((int) ((800 - paddleWidth) / 2),
                585), paddleWidth, 10);
    ...
    public void moveLeft() {
            ...
            double newX;
            if ((currentX) >= 30) {
                newX = currentX - this.paddleSpeed;
